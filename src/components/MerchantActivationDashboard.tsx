      ...
      months: [
        ...
        },
        {
          ...
          funnel_stages: [
            ...
            { stage: "email_confirmation", label: "Email Confirmation", count: 68786, percentage: 54.5, color: "#3B82F6" },
            { stage: "profile_start", label: "Profile Start", count: 122601, percentage: 97.1, color: "#8B5CF6" },
            { stage: "personal_info_submit", label: "Personal Info Submit", count: 88549, percentage: 70.1, color: "#EC4899" },
            { stage: "business_info_submit", label: "Business Info Submit", count: 86007, percentage: 68.1, color: "#F97316" },
            { stage: "account_setup_complete", label: "Account Setup Complete", count: 85834, percentage: 68.0, color: "#14B8A6" },
            { stage: "non_fraud_declined", label: "Non fraud Declined", count: 935, percentage: 0.74, color: "#22c55e" },
            { stage: "non_fraud_pending", label: "Non fraud Pending", count: 55949, percentage: 44.32, color: "#22c55e" },
            ...
            { stage: "activated_within_30d", label: "Activated within 30D", count: 13642, percentage: 19.66, color: "#90EE90" },
            { stage: "activated_between_30d_90d", label: "Activated b/w 30D-90D", count: 15991, percentage: 23.04, color: "#90EE90" },
            {
              stage: "receive_txn_attempted_within_30d",
              label: "Receive Txn < 30D",
              count: 3501,
              ...
              color: "#87CEEB",
              sub_category: [
                { stage: "ec_attempted_in_30D", label: "EC Txn Attempted within 30D", count: 2185, percentage: 3.15, has_error_codes: true },
                { stage: "wps_attempt_30d_1_0", label: "WPS Txn Attempted within 30D", count: 4, percentage: 0.01 },
                { stage: "invoice_attempt_30d_1_0", label: "Invoice Txn Attempted within 30D", count: 498, percentage: 0.72, has_error_codes: true },
                { stage: "subscription_attempt_30d_1_0", label: "Subscription Txn Attempted within 30D", count: 80, percentage: 0.12 },
                { stage: "p2p_attempt_30d_1_0", label: "P2P Txn Attempted within 30D", count: 72, percentage: 0.10 },
                { stage: "other_attempt_30d_1_0", label: "Other Txn Attempted within 30D", count: 20, percentage: 0.03 },
                { stage: "p2p_attempt_30d_personal", label: "P2P Txn (Personal) within 30D", count: 769, percentage: 1.11 },
              ],
            },
            { stage: "successful_sent_activity", label: "Successful Sent Activity (No Receive)", count: 5930, percentage: 8.54, color: "#FFB6C1" },
            { stage: "attempted_sent_activity", label: "Attempted Sent Activity (No Receive)", count: 11950, percentage: 17.22, color: "#FFC0CB" },
            { stage: "possible_personal_account", label: "Possible Personal Account (Only Sent Activity)", count: 12442, percentage: 17.93, color: "#FFB6D8" },
            { stage: "confirmed_identity", label: "Confirmed Identity (No Receive or Sent)", count: 14856, percentage: 21.41, color: "#DDA0DD" },
            { stage: "confirmed_identity_and_attempted", label: "Confirmed Identity and Attempted", count: 2576, percentage: 3.71, color: "#D8BFD8" },
            { stage: "confirmed_identity_and_sent", label: "Confirmed Identity and Sent", count: 7107, percentage: 10.24, color: "#E6D5E6" },
