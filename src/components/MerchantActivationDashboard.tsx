    ...
    () => ({
      "2025-11": {
        "2_login": [
          ...
          { pu_grouped: "https://www.paypal.com/businessmanage/profile/personalInformation/unifiedsettings/email", cnt: 5050 },
          ...
          { pu_grouped: "https://www.paypal.com/myaccount/money/flow/banks/new?flow=eyJyZXR1cm5VcmwiOiIvbWVwL2Rhc2hib2FyZCIsImNhbmNlbFVybCI6Ii9tZXAvZGFzaGJvYXJkIiwiZmxhZ3MiOlsiaXNJbk1vbmV5V2l0aENob2ljZSJdfQ==", cnt: 3861 },
        ...
        "5_10_login": [
          ...
          { pu_grouped: "https://www.paypal.com/myaccount/money/flow/banks/new?flow=eyJyZXR1cm5VcmwiOiIvbWVwL2Rhc2hib2FyZCIsImNhbmNlbFVybCI6Ii9tZXAvZGFzaGJvYXJkIiwiZmxhZ3MiOlsiaXNJbk1vbmV5V2l0aENob2ljZSJdfQ==", cnt: 1550 },
          { pu_grouped: "https://www.paypal.com/businessmanage/profile/personalInformation", cnt: 1355 },
          { pu_grouped: "https://www.paypal.com/businessmanage/profile/personalInformation/unifiedsettings/email", cnt: 1317 },
      ...
      "2025-10": {
        ...
        "5_10_login": [
          ...
          { pu_grouped: "https://www.paypal.com/myaccount/money/flow/banks/new?flow=eyJyZXR1cm5VcmwiOiIvbWVwL2Rhc2hib2FyZCIsImNhbmNlbFVybCI6Ii9tZXAvZGFzaGJvYXJkIiwiZmxhZ3MiOlsiaXNJbk1vbmV5V2l0aENob2ljZSJdfQ==", cnt: 630 },
          { pu_grouped: "https://www.paypal.com/mep/merchantapps/businesstools", cnt: 532 },
          { pu_grouped: "https://www.paypal.com/businessmanage/profile/personalInformation/unifiedsettings/email", cnt: 520 },
      ...
      months: [
        {
          ...
          funnel_stages: [
            ...
            { stage: "non_fraud", label: "Non-Fraud (excl preliminary risk identified)", count: 433442, percentage: 57.44, color: "#22c55e" },
            { stage: "email_confirmation", label: "Email Confirmation", count: 293687, percentage: 67.8, color: "#3B82F6" },
            { stage: "profile_start", label: "Profile Start", count: 422287, percentage: 97.4, color: "#8B5CF6" },
            { stage: "personal_info_submit", label: "Personal Info Submit", count: 338167, percentage: 78.0, color: "#EC4899" },
            { stage: "business_info_submit", label: "Business Info Submit", count: 303101, percentage: 69.9, color: "#F97316" },
            { stage: "account_setup_complete", label: "Account Setup Complete", count: 295390, percentage: 68.1, color: "#14B8A6" },
            {
            ...
            { stage: "contacted_gcs", label: "Contacted GCS", count: 4638, percentage: 1.66, color: "#F0E68C" },
            {
              ...
              breakdown: {
                ...
                "5_10_login": { count: 4376, color: "#800080", label: "5-10 Login", percentage: 1.56, has_page_urls: true },
        ...
        },
        {
          ...
          funnel_stages: [
            ...
            { stage: "non_fraud", label: "Non-Fraud (excl preliminary risk identified)", count: 455943, percentage: 73.23, color: "#22c55e" },
            { stage: "email_confirmation", label: "Email Confirmation", count: 321043, percentage: 70.4, color: "#3B82F6" },
            { stage: "profile_start", label: "Profile Start", count: 443585, percentage: 97.3, color: "#8B5CF6" },
            { stage: "personal_info_submit", label: "Personal Info Submit", count: 354823, percentage: 77.8, color: "#EC4899" },
            { stage: "business_info_submit", label: "Business Info Submit", count: 320300, percentage: 70.3, color: "#F97316" },
            { stage: "account_setup_complete", label: "Account Setup Complete", count: 307964, percentage: 67.5, color: "#14B8A6" },
        ...
        },
        {
          ...
          funnel_stages: [
            ...
            { stage: "non_fraud", label: "Non-Fraud (excl preliminary risk identified)", count: 113511, percentage: 46.05, color: "#22c55e" },
            { stage: "email_confirmation", label: "Email Confirmation", count: 63239, percentage: 55.7, color: "#3B82F6" },
            { stage: "profile_start", label: "Profile Start", count: 110607, percentage: 97.4, color: "#8B5CF6" },
            { stage: "personal_info_submit", label: "Personal Info Submit", count: 79703, percentage: 70.2, color: "#EC4899" },
            { stage: "business_info_submit", label: "Business Info Submit", count: 77679, percentage: 68.4, color: "#F97316" },
            { stage: "account_setup_complete", label: "Account Setup Complete", count: 77561, percentage: 68.3, color: "#14B8A6" },
            { stage: "non_fraud_declined", label: "Non fraud Declined", count: 522, percentage: 0.46, color: "#22c55e" },
            { stage: "non_fraud_pending", label: "Non fraud Pending", count: 50213, percentage: 44.24, color: "#22c55e" },
            ...
            { stage: "net_signups", label: "Net-Signups (Nonfraud = Allowed + lifted)", count: 66222, percentage: 58.34, color: "#4bc522" },
            { stage: "activated_within_30d", label: "Activated within 30D", count: 12405, percentage: 18.73, color: "#90EE90" },
            { stage: "activated_between_30d_90d", label: "Activated b/w 30D-90D", count: 12631, percentage: 19.07, color: "#90EE90" },
            {
              stage: "receive_txn_attempted_within_30d",
              label: "Receive Txn < 30D",
              count: 3551,
              ...
              color: "#87CEEB",
              sub_category: [
                { stage: "ec_attempted_in_30D", label: "EC Txn Attempted within 30D", count: 2185, percentage: 3.3, has_error_codes: true },
                { stage: "wps_attempt_30d_1_0", label: "WPS Txn Attempted within 30D", count: 5, percentage: 0.01 },
                { stage: "invoice_attempt_30d_1_0", label: "Invoice Txn Attempted within 30D", count: 500, percentage: 0.76, has_error_codes: true },
                { stage: "subscription_attempt_30d_1_0", label: "Subscription Txn Attempted within 30D", count: 121, percentage: 0.18 },
                { stage: "p2p_attempt_30d_1_0", label: "P2P Txn Attempted within 30D", count: 72, percentage: 0.11 },
                { stage: "other_attempt_30d_1_0", label: "Other Txn Attempted within 30D", count: 30, percentage: 0.05 },
                { stage: "p2p_attempt_30d_personal", label: "P2P Txn (Personal) within 30D", count: 796, percentage: 1.20 },
              ],
            },
            { stage: "successful_sent_activity", label: "Successful Sent Activity (No Receive)", count: 4697, percentage: 7.09, color: "#FFB6C1" },
            { stage: "attempted_sent_activity", label: "Attempted Sent Activity (No Receive)", count: 10433, percentage: 15.75, color: "#FFC0CB" },
            { stage: "possible_personal_account", label: "Possible Personal Account (Only Sent Activity)", count: 10702, percentage: 16.16, color: "#FFB6D8" },
            { stage: "confirmed_identity", label: "Confirmed Identity (No Receive or Sent)", count: 15789, percentage: 23.84, color: "#DDA0DD" },
            { stage: "confirmed_identity_and_attempted", label: "Confirmed Identity and Attempted", count: 2336, percentage: 3.53, color: "#D8BFD8" },
            { stage: "confirmed_identity_and_sent", label: "Confirmed Identity and Sent", count: 7451, percentage: 11.25, color: "#E6D5E6" },
            { stage: "contacted_gcs", label: "Contacted GCS", count: 2365, percentage: 3.57, color: "#F0E68C" },
            {
              ...
              breakdown: {
                ...
                "2_login": { count: 4680, color: "#006400", label: "2 Login", percentage: 7.07 },
                "3_4_login": { count: 2963, color: "#4169E1", label: "3-4 Login", percentage: 4.47 },
                "5_10_login": { count: 1094, color: "#800080", label: "5-10 Login", percentage: 1.65 },
